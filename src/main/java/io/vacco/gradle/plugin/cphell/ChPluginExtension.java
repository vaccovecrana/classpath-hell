...
public class ChPluginExtension {
  ...
  public Predicate<ResolvedArtifact> includeArtifact = a -> defaultArtifactInclude(a, artifactExclusions);
  // override to provide an alternative inclusion strategy to the default (exclude resources from black list)
  public Predicate<String> includeResource = r -> defaultResourceInclude(r, resourceExclusions);
